...
def test_load_no_permission(tmpdir):
     ...
     # Assuming the folder does not have write permissions
     protected_folder = tmpdir.mkdir("protected_folder")
     os.chmod(str(protected_folder), 0o444) # Read permissions only
